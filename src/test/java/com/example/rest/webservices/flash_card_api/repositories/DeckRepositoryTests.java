...
public class DeckRepositoryTests {
  ...
  void testCreateDeckThrowsFirestoreExceptionCase() throws Exception {
    ...
    RuntimeException exception =
        assertThrows(RuntimeException.class, () -> repository.createDeck(deck));
  ...
  void testRetrieveDeckByIdExecutionExceptionCase() throws Exception {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> repository.retrieveDeckById(testDeckId));
  ...
  void testRetrieveDeckByNameNotFoundExceptionCase() throws Exception {
    ...
    NotFoundException ex =
        assertThrows(NotFoundException.class, () -> repository.retrieveDeckByName(testDeckName));
  ...
  void testRetrieveDeckByNameExecutionExceptionCase() throws Exception {
    ...
    ExecutionException executionException =
        new ExecutionException("Firestore error", new Throwable());
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> repository.retrieveDeckByName(deckName));
  ...
  void testAddCardIdToDeckByIdExecutionExceptionCase() throws Exception {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> repository.addCardIdToDeckById(deckId, cardId));
  ...
  void testDeleteCardIdFromDeckByIdDeckNotFoundCase() throws Exception {
    ...
    NotFoundException ex = assertThrows(NotFoundException.class,
        () -> repository.deleteCardIdFromDeckById(id, cardId));
  ...
  void testDeleteCardIdFromDeckByIdFirestoreExceptionCase() throws Exception {
    ...
    when(collectionReference.document(eq(id))).thenReturn(documentReference);
    when(documentReference.get()).thenReturn(apiFuture);
    when(firestoreException.getCode())
        .thenReturn(FirestoreException.forInvalidArgument("", new Object()).getCode());
    when(apiFuture.get()).thenThrow(execEx);

    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> repository.deleteCardIdFromDeckById(id, cardId));
  ...
  void testUpdateDeckNameByIdFirestoreExceptionCase() throws Exception {
    ...
    RuntimeException ex =
        assertThrows(RuntimeException.class, () -> repository.updateDeckNameById(id, newName));
